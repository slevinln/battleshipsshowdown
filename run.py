...
def board_size_battleships():
    grid_size = input("How big should the board grid be? Please choose between 4 and 8: ")
    if int(grid_size)<= 3:
        ...
        print(f'Thank you for choosing the board size. It will be, {grid_size} x {grid_size}')
